...
const About = () => {
  ...
  return (
    <section id="about" ref={sectionRef} className="py-12 sm:py-16 md:py-20 px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12">
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-sm sm:text-base text-light-gray dark:text-light-gray leading-relaxed">
            ...
            {/* Quick Facts */}
            <div className="card">
              <h4 className="text-base sm:text-lg font-semibold text-white dark:text-white mb-4 flex items-center gap-2">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-xs sm:text-sm text-dark-gray dark:text-dark-gray">Location</p>
                    <p className="text-sm sm:text-base text-light-gray dark:text-light-gray">Matara, Sri Lanka</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-light-gray dark:text-light-gray mt-1 text-lg">🏫</span>
                  <div>
                    <p className="text-xs sm:text-sm text-dark-gray dark:text-dark-gray">University</p>
                    <p className="text-sm sm:text-base text-light-gray dark:text-light-gray">Sri Lanka Institute of Information Technology (SLIIT)</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-light-gray dark:text-light-gray mt-1 text-lg">🎓</span>
                  <div>
                    <p className="text-xs sm:text-sm text-dark-gray dark:text-dark-gray">Degree</p>
                    <p className="text-sm sm:text-base text-light-gray dark:text-light-gray">BSc (Hons) in Information Technology – Specialization: Artificial Intelligence</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-light-gray dark:text-light-gray mt-1 text-lg">🟢</span>
                ...
                <div className="flex items-start gap-3">
                  <span className="text-light-gray dark:text-light-gray mt-1 text-lg">🌐</span>
                  <div>
                    <p className="text-xs sm:text-sm text-dark-gray dark:text-dark-gray">Languages</p>
                    <p className="text-sm sm:text-base text-light-gray dark:text-light-gray">English, Sinhala</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            {/* What I Do */}
            <div className="card">
              <h4 className="text-base sm:text-lg font-semibold text-white dark:text-white mb-6 flex items-center gap-2">
                <span className="w-1 h-6 bg-white dark:bg-white rounded"></span>
                What I Do
              </h4>
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h5 className="text-sm sm:text-base text-white dark:text-white font-medium mb-1">AI/ML Model Training</h5>
                    <p className="text-xs sm:text-sm text-light-gray dark:text-light-gray">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h5 className="text-sm sm:text-base text-white dark:text-white font-medium mb-1">Full-Stack Development</h5>
                    <p className="text-xs sm:text-sm text-light-gray dark:text-light-gray">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h5 className="text-sm sm:text-base text-white dark:text-white font-medium mb-1">UI/UX Design</h5>
                    <p className="text-xs sm:text-sm text-light-gray dark:text-light-gray">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h5 className="text-sm sm:text-base text-white dark:text-white font-medium mb-1">Problem Solving</h5>
                    <p className="text-xs sm:text-sm text-light-gray dark:text-light-gray">
            ...
            <div className="card">
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                <div className="text-center p-3 sm:p-4 bg-dark-bg dark:bg-dark-bg rounded-lg border border-dark-border dark:border-dark-border">
                  <div className="text-xl sm:text-2xl mb-2">🎯</div>
                  <p className="text-xs sm:text-sm text-light-gray dark:text-light-gray font-medium">Quality First</p>
                </div>
                <div className="text-center p-3 sm:p-4 bg-dark-bg dark:bg-dark-bg rounded-lg border border-dark-border dark:border-dark-border">
                  <div className="text-xl sm:text-2xl mb-2">🚀</div>
                  <p className="text-xs sm:text-sm text-light-gray dark:text-light-gray font-medium">Innovation</p>
                </div>
                <div className="text-center p-3 sm:p-4 bg-dark-bg dark:bg-dark-bg rounded-lg border border-dark-border dark:border-dark-border">
                  <div className="text-xl sm:text-2xl mb-2">🤝</div>
                  <p className="text-xs sm:text-sm text-light-gray dark:text-light-gray font-medium">Collaboration</p>
                </div>
                <div className="text-center p-3 sm:p-4 bg-dark-bg dark:bg-dark-bg rounded-lg border border-dark-border dark:border-dark-border">
                  <div className="text-xl sm:text-2xl mb-2">📚</div>
                  <p className="text-xs sm:text-sm text-light-gray dark:text-light-gray font-medium">Learning</p>
                </div>
              </div>
            </div>
